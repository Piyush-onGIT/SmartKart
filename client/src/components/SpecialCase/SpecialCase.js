...
const SpecialCase = () => {
  ...
  return (
    <div className="fixed top-52 right-2 z-20 md:flex flex-col gap-2">
      <Link to="/">
        <div className="bg-white mb-2 w-16 h-[70px] rounded-md flex flex-col gap-1 text-[#33475b] justify-center items-center shadow-testShadow overflow-x-hidden group cursor-pointer">
